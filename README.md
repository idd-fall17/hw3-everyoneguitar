...
This small projects also teaches us how to wires when there is a lot. There are seven wires come out from strumming device, and seven plus five come out of gitar. The gitar was designed a groove to hold all wires in the middle. However, when we tried to have everything assemble together, we found the groove is too thin for all the wires. To solve the problem, we used spacers to provide more space between layers. <br>
